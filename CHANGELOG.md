...
## [5.0.0](https://github.com/aphexcx/phoenix/compare/arize-phoenix-v4.1.3...arize-phoenix-v5.0.0) (2024-05-22)


### ⚠ BREAKING CHANGES

* Remove `experimental` module ([#2945](https://github.com/aphexcx/phoenix/issues/2945))

### Features

* Add `log_traces` method that sends `TraceDataset` traces to Phoenix ([#2897](https://github.com/aphexcx/phoenix/issues/2897)) ([c8f9ed2](https://github.com/aphexcx/phoenix/commit/c8f9ed2cd031cb426bbd885bdf827e6c7aaf1c48))
...
* add a last N time range selector on project / projects pages ([#2907](https://github.com/aphexcx/phoenix/issues/2907)) ([3c115f8](https://github.com/aphexcx/phoenix/commit/3c115f872c189d9ce5c3742a147e2ce952ba94d8))
* add arize-phoenix support for python 3.12 ([#2555](https://github.com/aphexcx/phoenix/issues/2555)) ([aac0cd5](https://github.com/aphexcx/phoenix/commit/aac0cd5b3e7367fb1e791bad3bf80345520b75ea))
* Add ASGI root path parameter to Phoenix server ([#3186](https://github.com/aphexcx/phoenix/issues/3186)) ([e27cc5d](https://github.com/aphexcx/phoenix/commit/e27cc5d75f8edd3a86786838401a4ed4747624cd))
* add bedrock claude tracing tutorial ([#2919](https://github.com/aphexcx/phoenix/issues/2919)) ([b8b5240](https://github.com/aphexcx/phoenix/commit/b8b524045fd7531a82f02a82bc5c0659c263621e))
* add default limit to `/v1/spans` and corresponding client methods ([#3026](https://github.com/aphexcx/phoenix/issues/3026)) ([e5698d7](https://github.com/aphexcx/phoenix/commit/e5698d76e3b074aeb9f406f6c2f8948fcc85e04d))
* add gradient start/end to projects table ([#2956](https://github.com/aphexcx/phoenix/issues/2956)) ([5b6b217](https://github.com/aphexcx/phoenix/commit/5b6b21704a72002be9f75db2b85cd8cabdb7649a))
* add grpc endpoint ([#2232](https://github.com/aphexcx/phoenix/issues/2232)) ([8bbd136](https://github.com/aphexcx/phoenix/commit/8bbd136fe0975c6be353250f450bad75131a7637))
* Add indexes on Annotation tables ([#3082](https://github.com/aphexcx/phoenix/issues/3082)) ([682ecee](https://github.com/aphexcx/phoenix/commit/682eceeaf85873090eb322b97601334a0dbca72f))
* Add indexes on spans table ([#3098](https://github.com/aphexcx/phoenix/issues/3098)) ([12d2574](https://github.com/aphexcx/phoenix/commit/12d2574c62cc05cb46f9c066f5acd2c90fce7986))
* add opentelemetry trace instrumentation for Phoenix server ([#2990](https://github.com/aphexcx/phoenix/issues/2990)) ([6ed494e](https://github.com/aphexcx/phoenix/commit/6ed494e053fa62a53742ea4c272476ab4682553a))
...
* add trace and document evals to GET v1/evaluations ([#2910](https://github.com/aphexcx/phoenix/issues/2910)) ([79229f2](https://github.com/aphexcx/phoenix/commit/79229f20ae95d1cca5919aa9e5558a371a0422f1))
...
* Added support for default_headers for azure_openai. ([#2917](https://github.com/aphexcx/phoenix/issues/2917)) ([6ee5f24](https://github.com/aphexcx/phoenix/commit/6ee5f243951733e03b361fd16b05e9c80f3b9f2e))
* change docker base image to distroless ([#2708](https://github.com/aphexcx/phoenix/issues/2708)) ([89d6fe7](https://github.com/aphexcx/phoenix/commit/89d6fe7bfba0f8cc4feb791f6018cbd59a13a640))
* convert graphql api to pull trace evaluations from db ([#2867](https://github.com/aphexcx/phoenix/issues/2867)) ([11aa455](https://github.com/aphexcx/phoenix/commit/11aa455e53bedf5116db0d0c0e132b5f6dff2213))
* delete project ui ([#2593](https://github.com/aphexcx/phoenix/issues/2593)) ([7708805](https://github.com/aphexcx/phoenix/commit/770880567d299fc146bf343000e3cdb7e466cf99))
* Deprecate `datasets` module, rename to `inferences` ([#2785](https://github.com/aphexcx/phoenix/issues/2785)) ([4987ea3](https://github.com/aphexcx/phoenix/commit/4987ea37b1b9417f0c3b8d5fa7d4b4c8659b7503))
* Enable dynamic project switching ([#2537](https://github.com/aphexcx/phoenix/issues/2537)) ([0ef3224](https://github.com/aphexcx/phoenix/commit/0ef3224169b95210c0b2c85333309b1a3539b4d4))
...
* experimental span storage with append-only text files ([909672b](https://github.com/aphexcx/phoenix/commit/909672b1f2fd5f10a2cda9833abf4e3eb02b02eb))
* experimental span storage with append-only text files ([#2553](https://github.com/aphexcx/phoenix/issues/2553)) ([909672b](https://github.com/aphexcx/phoenix/commit/909672b1f2fd5f10a2cda9833abf4e3eb02b02eb))
* **experimental:** postgres support ([a2657d4](https://github.com/aphexcx/phoenix/commit/a2657d4a99f89aa9beb9b2529c624d88c1727ae7))
* fetch annotation names ([#2964](https://github.com/aphexcx/phoenix/issues/2964)) ([6c5d25d](https://github.com/aphexcx/phoenix/commit/6c5d25d4598451b19ad8e82f7d7a962a07f6968f))
* fetch document retrieval metrics per span using SQL ([#2960](https://github.com/aphexcx/phoenix/issues/2960)) ([9fdb765](https://github.com/aphexcx/phoenix/commit/9fdb7655efe9fe97897bcd818b2b5de93e5261cb))
* **gql:** add trace node and trace evaluations ([#2662](https://github.com/aphexcx/phoenix/issues/2662)) ([a985684](https://github.com/aphexcx/phoenix/commit/a9856847955da5a2dc00d22c4bab424049c94f77))
* graphql api pulls from db for document evaluations ([#2865](https://github.com/aphexcx/phoenix/issues/2865)) ([e4b667d](https://github.com/aphexcx/phoenix/commit/e4b667da68413b0e362d9b6ccd5d8434a4f1a208))
* **graphql:** embed project inside graphql span as private attribute ([#2522](https://github.com/aphexcx/phoenix/issues/2522)) ([9be1afa](https://github.com/aphexcx/phoenix/commit/9be1afa7ca9cb29698061a7fa334d2939b776456))
* grpc interceptor for prometheus ([#3056](https://github.com/aphexcx/phoenix/issues/3056)) ([610c8fa](https://github.com/aphexcx/phoenix/commit/610c8faa05da0af1697684ef8970105cfefb35a9))
* ingest document evals ([#2847](https://github.com/aphexcx/phoenix/issues/2847)) ([f3fde50](https://github.com/aphexcx/phoenix/commit/f3fde5093bf5c0f7de41c29b30c1b61d57c6ce48))
* ingest pyarrow span evals into sqlite ([#2837](https://github.com/aphexcx/phoenix/issues/2837)) ([3a6666c](https://github.com/aphexcx/phoenix/commit/3a6666c6663dfc597aeac365f2b3cf10acb095e8))
* ingest trace annotations ([#2852](https://github.com/aphexcx/phoenix/issues/2852)) ([792f674](https://github.com/aphexcx/phoenix/commit/792f6740070c4b42087a68a19df74ce7fc920f7c))
* launch_app() with experimental span storage using environment variables for storage path and storage type enums ([#2564](https://github.com/aphexcx/phoenix/issues/2564)) ([8a0b572](https://github.com/aphexcx/phoenix/commit/8a0b5729ea9a7b24d2ead37c212ae1a2839b128d))
* make graphql api for span evaluations read from database ([#2860](https://github.com/aphexcx/phoenix/issues/2860)) ([5adf750](https://github.com/aphexcx/phoenix/commit/5adf75078abb61923a8646dd0c5c6e454585a5e4))
* move document evaluation summary to pull from db ([#2888](https://github.com/aphexcx/phoenix/issues/2888)) ([73ca2d7](https://github.com/aphexcx/phoenix/commit/73ca2d7484c96cc4de360e4a5e9e3cf01af2b9f1))
* openapi ui for api exploration ([#3041](https://github.com/aphexcx/phoenix/issues/3041)) ([5b22961](https://github.com/aphexcx/phoenix/commit/5b22961bf70c7124686c1b86c750f30374fe7eca))
* **persistence:** add support for sorting by eval scores and labels ([#2977](https://github.com/aphexcx/phoenix/issues/2977)) ([44c3068](https://github.com/aphexcx/phoenix/commit/44c306854b95fa6d27d74d978a7355e01085189a))
* **persistence:** bulk inserter for spans ([#2808](https://github.com/aphexcx/phoenix/issues/2808)) ([9ce841e](https://github.com/aphexcx/phoenix/commit/9ce841eb1c9d4f248cae482992ab67447ae53fee))
* **persistence:** clear project ([#2976](https://github.com/aphexcx/phoenix/issues/2976)) ([665c166](https://github.com/aphexcx/phoenix/commit/665c166c282a15837508889e715e6a25dd20cffa))
* **persistence:** clear traces UI ([#2988](https://github.com/aphexcx/phoenix/issues/2988)) ([a717ff6](https://github.com/aphexcx/phoenix/commit/a717ff6c48d2b67dd7505bf2aa1d3db7f2c3e713))
* **persistence:** dataloader for document retrieval metrics ([#2978](https://github.com/aphexcx/phoenix/issues/2978)) ([f55c458](https://github.com/aphexcx/phoenix/commit/f55c4585e28b6941fba7f092922d34a083f88869))
* **persistence:** dataloader for span descendants ([#2980](https://github.com/aphexcx/phoenix/issues/2980)) ([d8e10d4](https://github.com/aphexcx/phoenix/commit/d8e10d4813338e90ba926daba64a279e140cc8fe))
* **persistence:** ensure migrations run for TreadSession ([#2855](https://github.com/aphexcx/phoenix/issues/2855)) ([ec4fea7](https://github.com/aphexcx/phoenix/commit/ec4fea7e9825d57b9dbb5318f013b18a7e1aec41))
* **persistence:** fetch latency_ms percentiles using sql with dataloaders ([#2818](https://github.com/aphexcx/phoenix/issues/2818)) ([48d4643](https://github.com/aphexcx/phoenix/commit/48d46432417473ea918d83fa5d2cb0dfd38bc499))
* **persistence:** fetch streaming_last_updated_at ([#2819](https://github.com/aphexcx/phoenix/issues/2819)) ([d665e49](https://github.com/aphexcx/phoenix/commit/d665e497945d94c862a6a4ed9f2b2491a17a36c2))
* **persistence:** get or delete projects using sql ([#2839](https://github.com/aphexcx/phoenix/issues/2839)) ([527b9a9](https://github.com/aphexcx/phoenix/commit/527b9a989f96089cf0b5463f30993c8d1ab02d13))
* **persistence:** json binary for postgres ([#2849](https://github.com/aphexcx/phoenix/issues/2849)) ([29351bf](https://github.com/aphexcx/phoenix/commit/29351bf77897b1c212951b9149bd595dfb120a3d))
* **persistence:** launch app with persist ([#2817](https://github.com/aphexcx/phoenix/issues/2817)) ([add6103](https://github.com/aphexcx/phoenix/commit/add6103874a79acd98c3a2506754c69de2e9d67f))
* **persistence:** make launch_app runnable on tmp directory ([#2851](https://github.com/aphexcx/phoenix/issues/2851)) ([f41e922](https://github.com/aphexcx/phoenix/commit/f41e9227d11fa18677520b2326b47843ce030de2))
* **persistence:** span annotation tables ([#2788](https://github.com/aphexcx/phoenix/issues/2788)) ([874c61e](https://github.com/aphexcx/phoenix/commit/874c61e3373eda4c8dd8334b68d8de457175ad25))
* **persistence:** span query DSL with SQL ([#2911](https://github.com/aphexcx/phoenix/issues/2911)) ([7c01420](https://github.com/aphexcx/phoenix/commit/7c01420115141b38c2d96167d0ef982923415486))
* **persistence:** sql persistence ([afd368d](https://github.com/aphexcx/phoenix/commit/afd368d6ba318a2fd8788158efab8f1207b01671))
* **persistence:** sql sorting for spans ([#2823](https://github.com/aphexcx/phoenix/issues/2823)) ([eeafb64](https://github.com/aphexcx/phoenix/commit/eeafb64379a63cc32f33c0d43f7ec5a77f4d8ab6))
* **persistence:** use sqlean v3.45.1 as sqlite engine ([#2947](https://github.com/aphexcx/phoenix/issues/2947)) ([3b202d7](https://github.com/aphexcx/phoenix/commit/3b202d70951a7424dde5b2d6fe82e29fab11785f))
* project archiving and deletion ([#2585](https://github.com/aphexcx/phoenix/issues/2585)) ([121f904](https://github.com/aphexcx/phoenix/commit/121f9047ce9fb1d9353f5275c9ae985db74fa1bf))
* **projects:** add support for the PHOENIX_PROJECT_NAME param ([#2515](https://github.com/aphexcx/phoenix/issues/2515)) ([6f24786](https://github.com/aphexcx/phoenix/commit/6f2478660aa6348153c11dba5dd43231a8a44df8))
* Remove `experimental` module ([#2945](https://github.com/aphexcx/phoenix/issues/2945)) ([01758cf](https://github.com/aphexcx/phoenix/commit/01758cffd8cf72d2c3a892faa01174b9f2f42c7b))
* restrict project metrics to be last 7 days ([#2896](https://github.com/aphexcx/phoenix/issues/2896)) ([066bc16](https://github.com/aphexcx/phoenix/commit/066bc16b7543f9e889b58dac31614ca17c2117be))
* span filtering by span evaluations ([#2923](https://github.com/aphexcx/phoenix/issues/2923)) ([4458ec4](https://github.com/aphexcx/phoenix/commit/4458ec404bd1d1e51fb466eb65e73733281e13c8))
* Support basic auth ([#3061](https://github.com/aphexcx/phoenix/issues/3061)) ([3202256](https://github.com/aphexcx/phoenix/commit/320225659ee1fd0eee19aea889304fc3f03fa0fc))
* support for span evaluations to get evaluations endpoint ([#2900](https://github.com/aphexcx/phoenix/issues/2900)) ([379e336](https://github.com/aphexcx/phoenix/commit/379e3364f173d2c9fe399c68194489a511dcf7b2))
* support pagination on spans resolver ([#3046](https://github.com/aphexcx/phoenix/issues/3046)) ([2113c5c](https://github.com/aphexcx/phoenix/commit/2113c5c525113a64a1d03d50261e511e69dd6374))
* **trace:** context manager to pause tracing ([#2520](https://github.com/aphexcx/phoenix/issues/2520)) ([6bf7232](https://github.com/aphexcx/phoenix/commit/6bf7232116ba406085957be60028c994547205d6))
* Update API for OpenAPI compliance ([#2866](https://github.com/aphexcx/phoenix/issues/2866)) ([0db65d8](https://github.com/aphexcx/phoenix/commit/0db65d8d9d3bb1213c0957dae693413db585bc14))
* Update eval summaries to use persistence ([#2920](https://github.com/aphexcx/phoenix/issues/2920)) ([06eb320](https://github.com/aphexcx/phoenix/commit/06eb320bd647d8c701fc25c58e910e7d8324b144))


### Bug Fixes

* add the remainder of the sentence ([#2903](https://github.com/aphexcx/phoenix/issues/2903)) ([eb4d0a5](https://github.com/aphexcx/phoenix/commit/eb4d0a55b16797a1782653666c73d63d9a54130e))
* add the remainder of the sentence ([#2903](https://github.com/aphexcx/phoenix/issues/2903)) ([64874b8](https://github.com/aphexcx/phoenix/commit/64874b8eed7c808801a5a5a14fc63c90631b28c5))
* Always wait a small amount of time between inserts ([#3168](https://github.com/aphexcx/phoenix/issues/3168)) ([6e18e3c](https://github.com/aphexcx/phoenix/commit/6e18e3c5fc75d96cfb937ebb1ea5b66e369c3ffd))
* backward compatible truthiness for query from dict parsing ([#3124](https://github.com/aphexcx/phoenix/issues/3124)) ([b425f9d](https://github.com/aphexcx/phoenix/commit/b425f9db7e6697b89f58ce77a15789d071522fec))
* Bulk inserter begins first insert immediately ([#3151](https://github.com/aphexcx/phoenix/issues/3151)) ([7e17cb2](https://github.com/aphexcx/phoenix/commit/7e17cb2fd091ad83885fc127083c20945ade530e))
* cartesian product in sql join ([#2959](https://github.com/aphexcx/phoenix/issues/2959)) ([c96092d](https://github.com/aphexcx/phoenix/commit/c96092d47c3a0f57157712bd5214be0d874a44eb))
* cartesian products in get_evaluations ([#3081](https://github.com/aphexcx/phoenix/issues/3081)) ([64ebec8](https://github.com/aphexcx/phoenix/commit/64ebec8a767f0af7d7417b67f921bad1f46a9d99))
* check payload for legacy project_name ([#3125](https://github.com/aphexcx/phoenix/issues/3125)) ([d7eae60](https://github.com/aphexcx/phoenix/commit/d7eae6017a4f4cb29ecc718a5c3353dfa402e650))
* close delete modal on delete ([#3069](https://github.com/aphexcx/phoenix/issues/3069)) ([083a467](https://github.com/aphexcx/phoenix/commit/083a467192e69ab9af2ee0f77d63720185a2119f))
* coerce `input.value` to string at ingestion ([#3147](https://github.com/aphexcx/phoenix/issues/3147)) ([3742ea7](https://github.com/aphexcx/phoenix/commit/3742ea7a479b2ad46b4787444ccef2daa1a6b6d7))
* commit insert into alembic_version ([#3115](https://github.com/aphexcx/phoenix/issues/3115)) ([93a144f](https://github.com/aphexcx/phoenix/commit/93a144f6b7b81cf5358196a02752c1e4961e999c))
* disable client-side sorting on trace/span tables ([#2958](https://github.com/aphexcx/phoenix/issues/2958)) ([139dc3e](https://github.com/aphexcx/phoenix/commit/139dc3ec4ff553b1d812ec46193d04acb07786da))
* disable grpc when readonly ([#3105](https://github.com/aphexcx/phoenix/issues/3105)) ([71ceba9](https://github.com/aphexcx/phoenix/commit/71ceba90904f4b98e86f6500de4a06aa9397a786))
* display newlines in explanations ([#2531](https://github.com/aphexcx/phoenix/issues/2531)) ([12e8a97](https://github.com/aphexcx/phoenix/commit/12e8a97404ac30b7348d55f46d34e952c79af93d))
* Dockerfile launches Phoenix that listens on IPv6 ([#3047](https://github.com/aphexcx/phoenix/issues/3047)) ([75cc979](https://github.com/aphexcx/phoenix/commit/75cc979e66b5193595380836c77a6126aceb2006))
* eliminate interference on global tracer provider ([#2998](https://github.com/aphexcx/phoenix/issues/2998)) ([5d7b843](https://github.com/aphexcx/phoenix/commit/5d7b8430335c26e15e635e623c1d5d18475c32e1))
* Enable listening on IPv6 ([#3037](https://github.com/aphexcx/phoenix/issues/3037)) ([dee6681](https://github.com/aphexcx/phoenix/commit/dee66811bc7feb9ef4a5c03dfb525f8a75193329))
* ensure recent version of opentelemetry-proto is used ([#2948](https://github.com/aphexcx/phoenix/issues/2948)) ([33647f5](https://github.com/aphexcx/phoenix/commit/33647f5c0b93040cec95152e5fecb77a7ad4c10f))
...
* fix docker build for sql ([b6d508d](https://github.com/aphexcx/phoenix/commit/b6d508d5aa286768e6fc87b58ed901b3c2f8222c))
* forbid blank or empty evaluation names ([#2962](https://github.com/aphexcx/phoenix/issues/2962)) ([cb87977](https://github.com/aphexcx/phoenix/commit/cb87977f764abbeabca112769d31ff23e6e008d6))
* handle numpy types in json.dumps for gql ([#2600](https://github.com/aphexcx/phoenix/issues/2600)) ([13cce4f](https://github.com/aphexcx/phoenix/commit/13cce4fdc6de1902ce143d3cf2287acb0d6578d8))
* ignore docs/ directory when formatting ([#2714](https://github.com/aphexcx/phoenix/issues/2714)) ([1340f74](https://github.com/aphexcx/phoenix/commit/1340f74000d8d94aa48611881aa8885995b7745b))
* improve error handling and logging for eval insertions ([#2854](https://github.com/aphexcx/phoenix/issues/2854)) ([d04694b](https://github.com/aphexcx/phoenix/commit/d04694b7db50fd032c4378ea9933206c0503ea63))
* include migration files ([#2887](https://github.com/aphexcx/phoenix/issues/2887)) ([b0a772e](https://github.com/aphexcx/phoenix/commit/b0a772ec017888165cabd53e2cbc7ff00ec752c3))
* increase attributes limit on spans ([#2575](https://github.com/aphexcx/phoenix/issues/2575)) ([94b1930](https://github.com/aphexcx/phoenix/commit/94b1930f7655f0cea3e889adc4962a01c8acbcf6))
* Invalidate cache on project reset ([#3113](https://github.com/aphexcx/phoenix/issues/3113)) ([2944ae5](https://github.com/aphexcx/phoenix/commit/2944ae586f05dd6a1e4425987137c098e14e60fb))
* join on `trace_id` in `get_qa_with_reference` ([#3248](https://github.com/aphexcx/phoenix/issues/3248)) ([a88d4ff](https://github.com/aphexcx/phoenix/commit/a88d4ff99b168f27b6492ed7247c9b3639fa3adc))
* long project names do not overflow and squash project icon ([#2686](https://github.com/aphexcx/phoenix/issues/2686)) ([b77bfaa](https://github.com/aphexcx/phoenix/commit/b77bfaa494d5a1d7d845b967d8a6fe6eff990b9b))
* need to check ".get()" because attribute may not be a dict ([#3267](https://github.com/aphexcx/phoenix/issues/3267)) ([3917fcc](https://github.com/aphexcx/phoenix/commit/3917fccbb4550db2fcdb23f288b42a2284dff59f))
* normalize datetime for phoenix client ([#3088](https://github.com/aphexcx/phoenix/issues/3088)) ([94a25ae](https://github.com/aphexcx/phoenix/commit/94a25ae42b3c3758b5e6bd8082d1adde155d8594))
* normalize telemetry url before setup ([#3001](https://github.com/aphexcx/phoenix/issues/3001)) ([28389e8](https://github.com/aphexcx/phoenix/commit/28389e8988b967c6693e4b5bab1586deb8245f29))
* parse files to detect sagemaker ([#2527](https://github.com/aphexcx/phoenix/issues/2527)) ([0761513](https://github.com/aphexcx/phoenix/commit/0761513c61e76418854881f918a04b25ef958466))
* **persistence:** db race condition between spans and evals ([#2905](https://github.com/aphexcx/phoenix/issues/2905)) ([2666464](https://github.com/aphexcx/phoenix/commit/2666464ce0bc19a6e8ab8f3267f78672393e72a8))
* **persistence:** import asert_never from typing_extensions ([#2850](https://github.com/aphexcx/phoenix/issues/2850)) ([62644cb](https://github.com/aphexcx/phoenix/commit/62644cbd905652efe6f4674a185781517e57fbbd))
* **persistence:** postgres down migration and url support ([#2915](https://github.com/aphexcx/phoenix/issues/2915)) ([4b4a776](https://github.com/aphexcx/phoenix/commit/4b4a776162986c5e9c4b94d41904187d0cda6236))
* **persistence:** postgres json calculations ([#2848](https://github.com/aphexcx/phoenix/issues/2848)) ([45f084d](https://github.com/aphexcx/phoenix/commit/45f084d1ce053c4036241dac069cb315e49c0c76))
* **persistence:** postgres timestamp insertion ([#2844](https://github.com/aphexcx/phoenix/issues/2844)) ([3477bb9](https://github.com/aphexcx/phoenix/commit/3477bb9bfa3c27c223e6d9144e1da4326e81975a))
* preserve loggers across migrations ([#2835](https://github.com/aphexcx/phoenix/issues/2835)) ([2821bb4](https://github.com/aphexcx/phoenix/commit/2821bb4fe9fda331fccc6aa6f4fd40a54661a18b))
* prevent browser caching of static assets ([#2549](https://github.com/aphexcx/phoenix/issues/2549)) ([038e56e](https://github.com/aphexcx/phoenix/commit/038e56e242032f27ebbb46b044a8549918ca1e8a))
* project name for evals ([#2648](https://github.com/aphexcx/phoenix/issues/2648)) ([14a3c2c](https://github.com/aphexcx/phoenix/commit/14a3c2c2f00d848602acfcdf0530337a9d05196b))
* **projects:** the home page should direct you to the projects page if there are multiple projects with data ([#2586](https://github.com/aphexcx/phoenix/issues/2586)) ([ced4e75](https://github.com/aphexcx/phoenix/commit/ced4e753823e77919d10c3c88e8a2ee08eaf5d21))
* prometheus transaction timers for bulkloader ([#3066](https://github.com/aphexcx/phoenix/issues/3066)) ([e0cc58d](https://github.com/aphexcx/phoenix/commit/e0cc58d1efe8291e326bd8077228cc44438ed283))
* Propagate migration errors and show an informative message ([#2994](https://github.com/aphexcx/phoenix/issues/2994)) ([3718e10](https://github.com/aphexcx/phoenix/commit/3718e107daf44252e867087df4a156d41773abe6))
* remove broken non-asyncio prometheus grpc server interceptor ([#3065](https://github.com/aphexcx/phoenix/issues/3065)) ([af75151](https://github.com/aphexcx/phoenix/commit/af751511b3d0aff03fc8027a1e50e40d89c3fab3))
* repair frontend build step in release pipeline  ([#2716](https://github.com/aphexcx/phoenix/issues/2716)) ([796eb6a](https://github.com/aphexcx/phoenix/commit/796eb6a95e039c37b8a4904df0d1c1061de0acd0))
* resolve rounding issue in postgres ([#3232](https://github.com/aphexcx/phoenix/issues/3232)) ([3b6c666](https://github.com/aphexcx/phoenix/commit/3b6c666cef077ed740b85e8583f2b6f452329dd6))
* round down time points to facilitate caching ([#3079](https://github.com/aphexcx/phoenix/issues/3079)) ([42b03c9](https://github.com/aphexcx/phoenix/commit/42b03c9466ab936caf79f2d5a75d3dee2c1d5ee3))
* run docker as nonroot user ([#3100](https://github.com/aphexcx/phoenix/issues/3100)) ([c640678](https://github.com/aphexcx/phoenix/commit/c6406782f91e5ebb7e930002f4c983a01bcffef9))
* safely unpack Evaluations proto in bulk inserter ([#2869](https://github.com/aphexcx/phoenix/issues/2869)) ([50517f7](https://github.com/aphexcx/phoenix/commit/50517f7c7e7fec53468e4da60a2e9942a409c68e))
* **sagemaker:** graphql base url was incorrect for sagemaker jupyterlab ([#2572](https://github.com/aphexcx/phoenix/issues/2572)) ([7ecf46e](https://github.com/aphexcx/phoenix/commit/7ecf46ee14a43010d3c9ff12eb84382633cd4b1d))
* sanitize base path ([#2573](https://github.com/aphexcx/phoenix/issues/2573)) ([f2647a2](https://github.com/aphexcx/phoenix/commit/f2647a2530babf4d91cf1d022f87df2584792baf))
* span and trace evaluation summaries ([#3013](https://github.com/aphexcx/phoenix/issues/3013)) ([088e6c2](https://github.com/aphexcx/phoenix/commit/088e6c20c32cccd6570b39072cb9759629d67431))
* span event to dict conversion ([#3009](https://github.com/aphexcx/phoenix/issues/3009)) ([3c73f03](https://github.com/aphexcx/phoenix/commit/3c73f03094b3462b355e4290a07b22280d68ea65))
* support minimal llama-index installations ([#2516](https://github.com/aphexcx/phoenix/issues/2516)) ([2469677](https://github.com/aphexcx/phoenix/commit/246967731bb211c5a891e0720a503aa8973803df))
* support numpy arrays in span to json encoder ([#2583](https://github.com/aphexcx/phoenix/issues/2583)) ([3a297d5](https://github.com/aphexcx/phoenix/commit/3a297d535a769ee462b70f2a49428016bd2a3c8c))
* switch license format  in toml ([5c6f345](https://github.com/aphexcx/phoenix/commit/5c6f345691dcab3d460823329ce31b9060bab02c))
* **trace:** eliminate truth ambiguity with non-empty numpy arrays ([#2626](https://github.com/aphexcx/phoenix/issues/2626)) ([be8ce7d](https://github.com/aphexcx/phoenix/commit/be8ce7dee124340521e30510d826f3973c4d4d9a))
* **trace:** query dsl for numpy arrays ([#2652](https://github.com/aphexcx/phoenix/issues/2652)) ([33f7c73](https://github.com/aphexcx/phoenix/commit/33f7c73ce4ed6e4b01ac5be7f54131c461b30dec))
* **trace:** redefine root span ([#2632](https://github.com/aphexcx/phoenix/issues/2632)) ([7940c9d](https://github.com/aphexcx/phoenix/commit/7940c9d4fbce2ec8674733e43d742411e26488c6))
* typo in SpanAnnotation ([#2967](https://github.com/aphexcx/phoenix/issues/2967)) ([f41044e](https://github.com/aphexcx/phoenix/commit/f41044ebfc3fc687d47eaf54d7510256f2998f9c))
* typo in trace annotation table name ([#2946](https://github.com/aphexcx/phoenix/issues/2946)) ([344b858](https://github.com/aphexcx/phoenix/commit/344b8582d6dff0a02d7f37bd7fe97186c54cef80))
* **ui:** broken context for markdown ([556e901](https://github.com/aphexcx/phoenix/commit/556e901c7dc19ed24fbb466c12fcbe03458070ec))
* **UI:** color rotation for markdown ([3184359](https://github.com/aphexcx/phoenix/commit/3184359487535331530000eda6e0b24f140f3530))
* **ui:** increase pagination size for TracePage ([#2642](https://github.com/aphexcx/phoenix/issues/2642)) ([6cd456f](https://github.com/aphexcx/phoenix/commit/6cd456fd4a4c3a9331379ee364221f4fce430c9c))
* **ui:** scroll column selector when long ([#2552](https://github.com/aphexcx/phoenix/issues/2552)) ([cbf8df8](https://github.com/aphexcx/phoenix/commit/cbf8df842b496a53af554552c0b3622d8353c9fd))
* **ui:** show formatted JSON for attributes ([0d1b719](https://github.com/aphexcx/phoenix/commit/0d1b71974b26d3fec228f07837dc4c7d2cfa2e18))
* **ui:** show formatted JSON for attributes ([09ad1be](https://github.com/aphexcx/phoenix/commit/09ad1be7c14c86ac5d68b0fc6216056591a386c3))
* unflatten attributes when loading spans from `trace_dataset` ([#3170](https://github.com/aphexcx/phoenix/issues/3170)) ([a165023](https://github.com/aphexcx/phoenix/commit/a165023144542a80642a5624797aba61745c9582))
* use environment variable for project name ([#2590](https://github.com/aphexcx/phoenix/issues/2590)) ([e2ace76](https://github.com/aphexcx/phoenix/commit/e2ace76c08ba5fe20c472934c051f1682d8d7d12))


### Documentation

* acquire tracer (GITBOOK-618) ([fe53df9](https://github.com/aphexcx/phoenix/commit/fe53df9dce1dade9679a5476feded05470415a34))
* Add `log_traces` tutorial ([#2902](https://github.com/aphexcx/phoenix/issues/2902)) ([e583f03](https://github.com/aphexcx/phoenix/commit/e583f03118f184de0e41a1dafe35731d099ad872))
* add LangChainJS auto instrumentation docs (GITBOOK-627) ([2f3cf7b](https://github.com/aphexcx/phoenix/commit/2f3cf7b4326587d24c1d9a76a4c0badaf1c8adb2))
* add link to manual instrumentation example (GITBOOK-617) ([ecaa8f5](https://github.com/aphexcx/phoenix/commit/ecaa8f5ea27617517cc674d1262c0bcc57d12bf6))
* Add link to Manual Instrumentation Tutorial (GITBOOK-624) ([e2613d1](https://github.com/aphexcx/phoenix/commit/e2613d111941feb919c549d805fdb45950c7c8f7))
* add links for projects (GITBOOK-574) ([ab77508](https://github.com/aphexcx/phoenix/commit/ab7750813c09ee11fd36241ed724f2c89d3cfdae))
* Add mistral (GITBOOK-594) ([78676af](https://github.com/aphexcx/phoenix/commit/78676afcde73da59a890f146bfc1674bdbc00716))
* add mistral instrumentation to notebook ([#2681](https://github.com/aphexcx/phoenix/issues/2681)) ([54dc47d](https://github.com/aphexcx/phoenix/commit/54dc47d9c745ce443e40659e8f69a2f1304b1ab1))
* add mistral instrumentor to mistral tutorial ([#2682](https://github.com/aphexcx/phoenix/issues/2682)) ([13fc1f8](https://github.com/aphexcx/phoenix/commit/13fc1f8a9d696b5a5087d504c32415818d120285))
* Add projects tutorial ([#2611](https://github.com/aphexcx/phoenix/issues/2611)) ([cca0a0e](https://github.com/aphexcx/phoenix/commit/cca0a0e1da6f16906dc2f39f33fec4cbe997f18e))
* Add provide_explanation=true code example in evals (GITBOOK-610) ([c31e07a](https://github.com/aphexcx/phoenix/commit/c31e07ac8f9738cd11f37d02592dd4827400187e))
* Add Qdrant + Langchain tracing example ([#2634](https://github.com/aphexcx/phoenix/issues/2634)) ([7f014f8](https://github.com/aphexcx/phoenix/commit/7f014f8c29d378fbf5fe7ead8f018cf4bd262ebc))
* Add Ragas as an integration (GITBOOK-575) ([9deabdf](https://github.com/aphexcx/phoenix/commit/9deabdf409c20dd17eaa307d5ee89925514527ae))
* add user guide image (GITBOOK-555) ([265b249](https://github.com/aphexcx/phoenix/commit/265b249e1f5ccdf06269591184c8f574817929e6))
* Added how-to guide (GITBOOK-549) ([f0294e8](https://github.com/aphexcx/phoenix/commit/f0294e8c84ad95d53327aee8f8ffbbdae3f162cb))
* Aman's Mar 11 changes (GITBOOK-550) ([b413d54](https://github.com/aphexcx/phoenix/commit/b413d54d54b75bc56f6c68ea8c7324f68358826a))
* Aman's Mar 21 changes (GITBOOK-592) ([607650e](https://github.com/aphexcx/phoenix/commit/607650e19f338c8a2040079052492affc05354c8))
* bump base image in kustomize ([#3193](https://github.com/aphexcx/phoenix/issues/3193)) ([5e8bc3d](https://github.com/aphexcx/phoenix/commit/5e8bc3dad2036b2febb1d343103d331723413a72))
* change-slug (GITBOOK-557) ([06b20dc](https://github.com/aphexcx/phoenix/commit/06b20dc2887fe6cf4a5abbb367fa81d170672ea9))
* clarify tab labels (GITBOOK-573) ([4b1f63b](https://github.com/aphexcx/phoenix/commit/4b1f63be01373d9bbcbe2be23bbadeebe984c441))
* Clean up Formatting (GITBOOK-603) ([ce3bfff](https://github.com/aphexcx/phoenix/commit/ce3bfff290ed4413703572918d7627f324870def))
* Clean up Formatting (GITBOOK-606) ([4eda5cf](https://github.com/aphexcx/phoenix/commit/4eda5cff5a60a75e41e3d4158b62bbd5a7a65cdd))
* Cleanup retrieval (GITBOOK-600) ([8c71e95](https://github.com/aphexcx/phoenix/commit/8c71e953693ecf93fdf3125c790d0156219f1392))
* Create an Arize sub-sections (GITBOOK-590) ([d38187e](https://github.com/aphexcx/phoenix/commit/d38187e5119aee8e5a6f1011a07991ac048902ba))
* Deprecate single how-to (GITBOOK-582) ([92816d1](https://github.com/aphexcx/phoenix/commit/92816d124f56319f0bb086f0e8f4212fd9e12c04))
* **development:** make it explicit that you need to run pnpm build ([#3035](https://github.com/aphexcx/phoenix/issues/3035)) ([672cbed](https://github.com/aphexcx/phoenix/commit/672cbedcea9746ee5ea1d6b61032931110a9b121))
* dockerize manual instrumentation example ([#2797](https://github.com/aphexcx/phoenix/issues/2797)) ([651efbe](https://github.com/aphexcx/phoenix/commit/651efbe56e6ce3be35b8471827d83a674b494230))
* document get_spans_dataframe (GITBOOK-569) ([d011bd8](https://github.com/aphexcx/phoenix/commit/d011bd8bacd1621ea396f6a6e0e4e7632bec949a))
* Edit evals quickstart install (GITBOOK-660) ([e3f6e08](https://github.com/aphexcx/phoenix/commit/e3f6e08ba1dbd1087178b30129c0859c26677385))
* Evals Structure! (GITBOOK-547) ([ac23311](https://github.com/aphexcx/phoenix/commit/ac23311c37cc7cdb0f1c53a64d229a66acd2e2a6))
* example using cron for online phoenix evals ([#2643](https://github.com/aphexcx/phoenix/issues/2643)) ([5ea99ef](https://github.com/aphexcx/phoenix/commit/5ea99ef8244d7b72901d6f78dc0b586d8e2a8086))
* fix concat,  add custom metadata (GITBOOK-587) ([682265c](https://github.com/aphexcx/phoenix/commit/682265cb19bfcc09dcfcd4cfa9a887be9028c362))
* Fix docker run command (GITBOOK-653) ([6867db0](https://github.com/aphexcx/phoenix/commit/6867db035ffb6546ac6656b0f0876868243427e2))
* fix hallucinations (GITBOOK-644) ([012e81d](https://github.com/aphexcx/phoenix/commit/012e81d8cef379ca50c9821b7190998faff22cbd))
* fix js (GITBOOK-613) ([d73d7c0](https://github.com/aphexcx/phoenix/commit/d73d7c01f31c0a51f539e804f8bfef0854b40559))
* fix links (GITBOOK-650) ([4f8057f](https://github.com/aphexcx/phoenix/commit/4f8057f19e1cf219f634306e50a20224e5220846))
* fix missing parentheses (GITBOOK-571) ([2353953](https://github.com/aphexcx/phoenix/commit/2353953cd8a0185f2fd8e391c72aaf340afc1cca))
* fix missing quotes (GITBOOK-572) ([9a5112c](https://github.com/aphexcx/phoenix/commit/9a5112c5d3fda9360308b7fddd8138508934aa64))
* fix online evals link (GITBOOK-589) ([696eac9](https://github.com/aphexcx/phoenix/commit/696eac925001af5cb811563510f698a760c5f73a))
* fix openinference link (GITBOOK-628) ([e233894](https://github.com/aphexcx/phoenix/commit/e2338940ce613510f970b4508e2c58d1ba66c85a))
* fix qa with reference tutorial ([e1db1ce](https://github.com/aphexcx/phoenix/commit/e1db1cee189e36311eb96f7473a8b496340907bc))
* fix qa with reference tutorial ([ba24950](https://github.com/aphexcx/phoenix/commit/ba249507f24dca801a3986e6275dae5f468ef362))
* fix tracing name (GITBOOK-559) ([553a6d2](https://github.com/aphexcx/phoenix/commit/553a6d256210db60ce82c830666b54db63472081))
* fix typo (GITBOOK-544) ([01da282](https://github.com/aphexcx/phoenix/commit/01da2826182c2fa5739b519691926c8ea9615fde))
* fix typo (GITBOOK-566) ([a5d7f12](https://github.com/aphexcx/phoenix/commit/a5d7f124a71afa29529dcfe9efe011ff464f80df))
* fix variable name (GITBOOK-604) ([0a4f958](https://github.com/aphexcx/phoenix/commit/0a4f9586d0eb2f3146e810c301860201388d6910))
* fix version for llama-index-callbacks-arize-phoenix (GITBOOK-649) ([dd1e9d6](https://github.com/aphexcx/phoenix/commit/dd1e9d61e4fe09f96da9f08fd2d15f53c4c45aee))
* Fixed typos "a n example" (GITBOOK-638) ([f5e34c4](https://github.com/aphexcx/phoenix/commit/f5e34c4addeb55eca51e28bbb50e1cbb6d55153b))
* fixing typo in "inferences" (GITBOOK-586) ([89ea4fc](https://github.com/aphexcx/phoenix/commit/89ea4fc3e42f432ec1a8b3df110110a5591b8006))
* grammar fixes (GITBOOK-607) ([12ad43d](https://github.com/aphexcx/phoenix/commit/12ad43dfc5809144cfae33ac2e037b90f1d58006))
* Improve projects-related API docstrings ([#2589](https://github.com/aphexcx/phoenix/issues/2589)) ([9eebb00](https://github.com/aphexcx/phoenix/commit/9eebb00ea63529ad9b12f2a4aad6716fe1088c05))
* make dockerhub URL go to public ([6650f67](https://github.com/aphexcx/phoenix/commit/6650f6729117e192de9e2435ed543c01b654f2aa))
* manually instrumented chatbot ([#2730](https://github.com/aphexcx/phoenix/issues/2730)) ([46be32b](https://github.com/aphexcx/phoenix/commit/46be32b54438a5cc9dc26948138ddacd36699409))
* Minor cleanup (GITBOOK-578) ([ad2692e](https://github.com/aphexcx/phoenix/commit/ad2692ecc4cb6da53e08e630bd67bf4b986d1a88))
* Mistral (GITBOOK-595) ([f245844](https://github.com/aphexcx/phoenix/commit/f2458443df8f474ea8b238fbc0d4faa2dfe5b437))
* mistral tutorial ([#2627](https://github.com/aphexcx/phoenix/issues/2627)) ([97d4096](https://github.com/aphexcx/phoenix/commit/97d4096876ab2c84de5d6c1e76e073b0d9824cd7))
* More cleanup on tracing (GITBOOK-581) ([434af68](https://github.com/aphexcx/phoenix/commit/434af6891a249cd98a4c4b55e8a14136f2040cd4))
* more project docs (GITBOOK-585) ([0c13fe5](https://github.com/aphexcx/phoenix/commit/0c13fe50cf6af7fbf887ee4d2d049f8e0aa0fab9))
* Move more to how-to tracing (GITBOOK-580) ([9a36e37](https://github.com/aphexcx/phoenix/commit/9a36e37ba7913cfddcb69ee9b8b82b110a7191c6))
* Nest auto and manual instrumentation in how-to (GITBOOK-558) ([14c4303](https://github.com/aphexcx/phoenix/commit/14c43032eb9f6e3bdd69876ac3e1f934d66260bf))
* new TS sections (GITBOOK-626) ([c8dee72](https://github.com/aphexcx/phoenix/commit/c8dee72db578554709d9ff10ca0c1d052ec92e54))
* new updated readme ([#3231](https://github.com/aphexcx/phoenix/issues/3231)) ([f728447](https://github.com/aphexcx/phoenix/commit/f728447851806e4c4def2440100ff38a52185429))
* nix unnecessary config section (GITBOOK-577) ([75e5182](https://github.com/aphexcx/phoenix/commit/75e5182fa4caf23a28430cabb0eb39f893361550))
* No subject (GITBOOK-553) ([41e0f9e](https://github.com/aphexcx/phoenix/commit/41e0f9eca595fdd002f54c8676cc6df2b6cce854))
* No subject (GITBOOK-554) ([7fc4b5e](https://github.com/aphexcx/phoenix/commit/7fc4b5e73ecf057ebbf7a6493d58d780a912d438))
* No subject (GITBOOK-562) ([84e3cdb](https://github.com/aphexcx/phoenix/commit/84e3cdb7870dcef6d4bd139b065601a6893e1e86))
* No subject (GITBOOK-563) ([ae4f102](https://github.com/aphexcx/phoenix/commit/ae4f102554b6e46bf70210edd961ab8faefb872e))
* No subject (GITBOOK-564) ([510a043](https://github.com/aphexcx/phoenix/commit/510a043aac2c1ab0a3d4571f6c7ef6a5a66768f0))
* No subject (GITBOOK-565) ([905af06](https://github.com/aphexcx/phoenix/commit/905af06f09f52e2004e9af0edc7075694289a593))
* No subject (GITBOOK-567) ([ea6201a](https://github.com/aphexcx/phoenix/commit/ea6201a00e68a9a2b926f6d546e51042b2904751))
* No subject (GITBOOK-579) ([d8e8df2](https://github.com/aphexcx/phoenix/commit/d8e8df2986f5f6aeae0ca44915bda95c5dfcf568))
* No subject (GITBOOK-591) ([4472c16](https://github.com/aphexcx/phoenix/commit/4472c167b454f6b731036aafb4cd01fb0737ce2b))
* No subject (GITBOOK-597) ([b6196ac](https://github.com/aphexcx/phoenix/commit/b6196ac8f7e05155f352180e712f282a1fc510d7))
* No subject (GITBOOK-598) ([f6a2bd6](https://github.com/aphexcx/phoenix/commit/f6a2bd6491838440b05a5bfa93d83facad0e2dca))
* No subject (GITBOOK-605) ([7f09d88](https://github.com/aphexcx/phoenix/commit/7f09d8875cee9a91f7104303f527aab1a54d2fce))
* No subject (GITBOOK-616) ([237a844](https://github.com/aphexcx/phoenix/commit/237a84456680b5ec6f976463aeff45b580839712))
* No subject (GITBOOK-620) ([df93e0e](https://github.com/aphexcx/phoenix/commit/df93e0e58631ba03c238eb7d5923b2e4b3598fda))
* No subject (GITBOOK-622) ([ef0094f](https://github.com/aphexcx/phoenix/commit/ef0094f8fe0a3304481e5c9456af65a40c90a523))
* No subject (GITBOOK-623) ([4e60b9d](https://github.com/aphexcx/phoenix/commit/4e60b9d4f711cfba207d45e6087277d1291149e0))
* No subject (GITBOOK-635) ([f50bc54](https://github.com/aphexcx/phoenix/commit/f50bc54ae8fd61c2153ea46a8c84a8740b2ca697))
* No subject (GITBOOK-636) ([21d0127](https://github.com/aphexcx/phoenix/commit/21d01270ac442321c7e4cf7448d66f5c5162b4b1))
* No subject (GITBOOK-637) ([b804441](https://github.com/aphexcx/phoenix/commit/b804441041282a825d6ba102a4f18080f151cfdc))
* No subject (GITBOOK-647) ([4f102d2](https://github.com/aphexcx/phoenix/commit/4f102d2a08e09833e3fb0e96c3a25328c8e70d6c))
* No subject (GITBOOK-648) ([0ac0c18](https://github.com/aphexcx/phoenix/commit/0ac0c181f0842ad27b7bc81f82572fd33c778e53))
* No subject (GITBOOK-654) ([9dd2214](https://github.com/aphexcx/phoenix/commit/9dd221465fd69ad39fedd01b7e33fd0f324c9f0e))
* No subject (GITBOOK-655) ([413a623](https://github.com/aphexcx/phoenix/commit/413a623c28eba5f0266065bd360102fc2088d873))
* No subject (GITBOOK-656) ([ab8b21d](https://github.com/aphexcx/phoenix/commit/ab8b21dc8c1f04b5ecd2611b9321fe9589ad6c21))
* No subject (GITBOOK-657) ([9a97226](https://github.com/aphexcx/phoenix/commit/9a9722670577620ca1ce8a3444f3882fcb5be415))
* No subject (GITBOOK-658) ([c36aaec](https://github.com/aphexcx/phoenix/commit/c36aaec287af18600519daa403687f35a6f99a6b))
* Online Evals (GITBOOK-561) ([659f186](https://github.com/aphexcx/phoenix/commit/659f186d87fe96a5f8d6a507ffbf6a33e715f2d4))
* overview of save and load (GITBOOK-608) ([3bdb8db](https://github.com/aphexcx/phoenix/commit/3bdb8db077d74c2777e5ff4d17557bc7e4d30e27))
* persistence (GITBOOK-632) ([ef9eeb8](https://github.com/aphexcx/phoenix/commit/ef9eeb81e888be5faa460b915a6e480c4d2ea751))
* PHOENIX_WORKING_DIR default value documentation ([#3190](https://github.com/aphexcx/phoenix/issues/3190)) ([6957bd9](https://github.com/aphexcx/phoenix/commit/6957bd94c80d646c07ce38696f82331a9d91094a))
* re-organize concepts and setup (GITBOOK-576) ([ddaeaa2](https://github.com/aphexcx/phoenix/commit/ddaeaa2c7263f0dcbd728e334c2a5fab489bff1b))
* Remove arbitrary nesting of concepts (GITBOOK-612) ([84d73ba](https://github.com/aphexcx/phoenix/commit/84d73ba6aa77e6a846438e7eb772bac9f47f377f))
* remove azure link (GITBOOK-652) ([5eeadf1](https://github.com/aphexcx/phoenix/commit/5eeadf163012984719c034fcdf8892e4ac2e8601))
* remove experimental from docs ([#3031](https://github.com/aphexcx/phoenix/issues/3031)) ([3ca2ebd](https://github.com/aphexcx/phoenix/commit/3ca2ebd2e5b12b1e3a62a23b563dabad26dba32d))
* Remove experimental on evals (GITBOOK-583) ([c064923](https://github.com/aphexcx/phoenix/commit/c0649237f6861a0bc0a109ecd4b8c89d9640b014))
* remove experimental tags in code ([4c4a832](https://github.com/aphexcx/phoenix/commit/4c4a832adb874a151821b1ef46a709daf5091003))
* Remove hint for versions (GITBOOK-651) ([698540b](https://github.com/aphexcx/phoenix/commit/698540bf1405c04cd89843364839e0f42add5cea))
* Remove pinecone notebook ([#2665](https://github.com/aphexcx/phoenix/issues/2665)) ([9f1c1d4](https://github.com/aphexcx/phoenix/commit/9f1c1d45b777673fe39e940415a7a9f4c8120e72))
* Rework of Quickstart Evals (GITBOOK-631) ([9bb9732](https://github.com/aphexcx/phoenix/commit/9bb97321b20a6fcbdbed135af5bc0830427084f8))
* Save and Load Traces (GITBOOK-602) ([29a65b6](https://github.com/aphexcx/phoenix/commit/29a65b6cd3b58d88ce9825b2d71b21d55f33881e))
* simplify llama-index (GITBOOK-543) ([c1f84aa](https://github.com/aphexcx/phoenix/commit/c1f84aab74939af0d0e724c2edb6810a6772bc1e))
* Simplify nav (GITBOOK-548) ([b0ceb1b](https://github.com/aphexcx/phoenix/commit/b0ceb1ba326ff001b6365498782933cdfacff0ab))
* Split out concepts fortracing (GITBOOK-546) ([e8d3fdb](https://github.com/aphexcx/phoenix/commit/e8d3fdb08d7bc5218fc796dd261cf1fa903bbc14))
* SQL Eval Addition (GITBOOK-619) ([065414a](https://github.com/aphexcx/phoenix/commit/065414a73665d843a7435f48ca9777abafc0f94b))
* Supported Models V1 (GITBOOK-560) ([a550dd7](https://github.com/aphexcx/phoenix/commit/a550dd76269f48f34beffb215dde9853e764a905))
* trace a deployed app (GITBOOK-593) ([08623ea](https://github.com/aphexcx/phoenix/commit/08623eaa6354c7b70a5ac8c78ac9a5a939aefeec))
* Typo fix (GITBOOK-640) ([f216b2a](https://github.com/aphexcx/phoenix/commit/f216b2a215a37e8f3b6af2cd896b75453fcf4e62))
* update cron evals documentation (GITBOOK-588) ([a4ef19c](https://github.com/aphexcx/phoenix/commit/a4ef19cdd3273dc90c4d7cb9e1e76990147f50e7))
* update kustomize k8s manifests ([#3148](https://github.com/aphexcx/phoenix/issues/3148)) ([ba166af](https://github.com/aphexcx/phoenix/commit/ba166af8a0ebdd96c8b0671f5a8ddfb36bcedbd8))
* Update Langchain Example Link in Quickstart Retrieval (GITBOOK-615) ([3189a72](https://github.com/aphexcx/phoenix/commit/3189a726c3ff3c3b329311247a75f0700a6af6f3))
* Update projects section (GITBOOK-584) ([e11885f](https://github.com/aphexcx/phoenix/commit/e11885f8083d6c5a883a8145d1097547de7f5c5e))
* Update pyproject.toml with proper biline ([4fdf710](https://github.com/aphexcx/phoenix/commit/4fdf710057a6fd19c75df133ed28206c35597eee))
* update the user guide (GITBOOK-599) ([cc4fa11](https://github.com/aphexcx/phoenix/commit/cc4fa11837c1c497f58ca4f3ee181999b5348b15))
* update tracing section with project info (GITBOOK-568) ([888535a](https://github.com/aphexcx/phoenix/commit/888535a1bb8a51b70c9fe1d12a6755caea5c174e))
* use projects with ragas ([#2569](https://github.com/aphexcx/phoenix/issues/2569)) ([1e7b31d](https://github.com/aphexcx/phoenix/commit/1e7b31d7a17d048956732cdb8f70102d74ec6c5b))
